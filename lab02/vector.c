...
// Because when this func return, the vector which has been alloc will be free (v is on stack)
...
// It works but pass-by-value really wastes memory
...
vector_t *vector_new() {
    ...
    if (!retval->data) {
        free(retval);				//Why is this line necessary?
                                    //Free the memory on heap which is malloced.
        allocation_failed();
    }
